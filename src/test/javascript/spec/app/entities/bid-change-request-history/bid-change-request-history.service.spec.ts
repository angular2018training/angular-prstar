...
describe('Service Tests', () => {
    ...
    describe('BidChangeRequestHistory Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(BidChangeRequestHistoryService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/bid-change-request-histories';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return BidChangeRequestHistory', () => {
