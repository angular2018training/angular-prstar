...
describe('Project e2e test', () => {
    ...
    it('should load Projects', () => {
        ...
        expect(projectComponentsPage.getTitle())
            .toMatch(/prostarsWebApp.project.home.title/);
    ...
    it('should load create Project dialog', () => {
        ...
        expect(projectDialogPage.getModalTitle())
            .toMatch(/prostarsWebApp.project.home.createOrEditLabel/);
        projectDialogPage.close();
    });

    it('should create and save Projects', () => {
        projectComponentsPage.clickOnCreateButton();
        projectDialogPage.setStartDateInput(12310020012301);
        expect(projectDialogPage.getStartDateInput()).toMatch('2001-12-31T02:30');
        projectDialogPage.setEndDateInput(12310020012301);
        expect(projectDialogPage.getEndDateInput()).toMatch('2001-12-31T02:30');
