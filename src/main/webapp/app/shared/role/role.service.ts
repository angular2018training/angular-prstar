...
export class RoleService {
 ...
 //   GET /api/role/roles_by_project/{projectId}
    ...
    queryGetById(projectId: number): Observable<HttpResponse<Role[]>> {
        const options = createRequestOption(projectId);
        return this.http.get<Role[]>(`${'/api/role/roles_by_project'}/${projectId}`, { params: options, observe: 'response' })
            .map((res: HttpResponse<Role[]>) => this.convertArrayResponse(res));
    }
