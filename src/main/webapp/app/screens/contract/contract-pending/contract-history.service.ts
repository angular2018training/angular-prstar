...
export class ContractHistoryService {
    ...
    queryHistory(contractId: number): Observable<HttpResponse<ContractHistory[]>> {
        const options = createRequestOption();
        return this.http.get<ContractHistory[]>(`${'/api/contract-histories'}/${contractId}`, { params: options, observe: 'response' })
