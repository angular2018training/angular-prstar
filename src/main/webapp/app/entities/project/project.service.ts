...
export class ProjectService {
    ...
    private projectByRoleResourceUrl =  SERVER_API_URL + 'api/projects/pro_requirement/';
    ...
    loadProject(req?: any): Observable<HttpResponse<Project[]>> {
    ...
    getProjectByProRequirement(id): Observable<HttpResponse<Project>> {
        return this.http.get<Project>(`${this.projectByRoleResourceUrl}/${id}`, { observe: 'response'})
            .map((res: EntityResponseType) => this.convertResponse(res));
    }
